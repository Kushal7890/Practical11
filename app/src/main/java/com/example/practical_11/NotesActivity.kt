...
class NotesActivity : AppCompatActivity() {
    ...
    private lateinit var databaseHelper: com.example.practical_11.DatabaseHelper
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val guniimg = findViewById<ImageView>(R.id.imagebyimagenotes)
        guniimg.setBackgroundResource(R.drawable.image_animation)
        ...
        databaseHelper = com.example.practical_11.DatabaseHelper(this)
